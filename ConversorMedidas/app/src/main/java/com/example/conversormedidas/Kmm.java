...
public class Kmm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnBackProg = (Button) findViewById(R.id.btnBack);
        btnBackProg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(Kmm.this,MainActivity.class);
                startActivity(it);
            }
        });
    }
